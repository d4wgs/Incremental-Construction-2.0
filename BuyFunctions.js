...
function buyShack10() {
    if (Cash >= ShackCost) {
      Cash = Cash - ShackCost;
      Shack = Shack + 10;
      ShackCost = Math.round(ShackCost * (1.05^10));
      ShackCount = Shack;
      ShackTotCost1 = ShackCost;
  ...
  function buyShack100() {
    if (Cash >= ShackCost) {
      Cash = Cash - ShackCost;
      Shack = Shack + 100;
      ShackCost = Math.round(ShackCost * (1.05^100));
      ShackCount = Shack;
      ShackTotCost1 = ShackCost;
  ...
  function buyApartment10() {
    if (Cash >= ApartmentCost) {
      ...
      ApartmentCost = Math.round(ApartmentCost * (1.05^10));
      ApartmentCount = Apartment;
      ApartmentTotCost1 = ApartmentCost;
  ...
  function buyApartment100() {
    if (Cash >= ApartmentCost) {
      ...
      ApartmentCost = Math.round(ApartmentCost * (1.05^100));
      ApartmentCount = Apartment;
      ApartmentTotCost1 = ApartmentCost;
  ...
  function buyHouse10() {
    if (Cash >= HouseCost) {
      Cash = Cash - HouseCost;
      House = House + 10;
      HouseCost = Math.round(HouseCost * (1.05^10));
      HouseCount = House;
      HouseTotCost1 = HouseCost;
  ...
  function buyHouse100() {
    if (Cash >= HouseCost) {
      Cash = Cash - HouseCost;
      House = House + 100;
      HouseCost = Math.round(HouseCost * (1.05^100));
      HouseCount = House;
      HouseTotCost1 = HouseCost;
  ...
  function buyMotel10() {
    if (Cash >= MotelCost) {
      Cash = Cash - MotelCost;
      Motel = Motel + 10;
      MotelCost = Math.round(MotelCost * (1.05^10));
      MotelCount = Motel;
      MotelTotCost1 = MotelCost;
  ...
  function buyMotel100() {
    if (Cash >= MotelCost) {
      Cash = Cash - MotelCost;
      Motel = Motel + 100;
      MotelCost = Math.round(MotelCost * (1.05^100));
      MotelCount = Motel;
      MotelTotCost1 = MotelCost;
  ...
  function buyApartmentComplex10() {
    if (Cash >= ApartmentComplexCost) {
      ...
      ApartmentComplexCost = Math.round(ApartmentComplexCost * (1.05^10));
      ApartmentComplexCount = ApartmentComplex;
      ApartmentComplexTotCost1 = ApartmentComplexCost;
  ...
  function buyApartmentComplex100() {
    if (Cash >= ApartmentComplexCost) {
      ...
      ApartmentComplexCost = Math.round(ApartmentComplexCost * (1.05^100));
      ApartmentComplexCount = ApartmentComplex;
      ApartmentComplexTotCost1 = ApartmentComplexCost;
  ...
  function buyTower10() {
    if (Cash >= TowerCost) {
      Cash = Cash - TowerCost;
      Tower = Tower + 10;
      TowerCost = Math.round(TowerCost * (1.05^10));
      TowerCount = Tower;
      TowerTotCost1 = TowerCost;
  ...
  function buyTower100() {
    if (Cash >= TowerCost) {
      Cash = Cash - TowerCost;
      Tower = Tower + 100;
      TowerCost = Math.round(TowerCost * (1.05^100));
      TowerCount = Tower;
      TowerTotCost1 = TowerCost;
  ...
  function buySkyscraper10() {
    if (Cash >= SkyscraperCost) {
      ...
      SkyscraperCost = Math.round(SkyscraperCost * (1.05^10));
      SkyscraperCount = Skyscraper;
      SkyscraperTotCost1 = SkyscraperCost;
  ...
  function buySkyscraper100() {
    if (Cash >= SkyscraperCost) {
      ...
      SkyscraperCost = Math.round(SkyscraperCost * (1.05^100));
      SkyscraperCount = Skyscraper;
      SkyscraperTotCost1 = SkyscraperCost;
  ...
  function buyReputation() {
    if (Skyscraper >= ReputationCost) {
      ...
      ReputationCost = Math.round(ReputationCost * 1.1);
  ...
  function buyESBuilding() {
    if (Reputation >= ESBuildingCost) {
      Reputation = Reputation - ESBuildingCost;
      ESBuilding = ESBuilding + 1;
      ESBuildingCost = Math.round(ESBuildingCost * 1);
